...
|
*/
$config['base_url']	= "http://127.0.0.1/dropinn_free5.0/dropinn_standard5.0/";
...
$config['db_password'] = "letitbefree";
$config['db'] = "dropinn50";
...
$config['basepath'] 				    =  $_SERVER['DOCUMENT_ROOT'].'/dropinn_free5.0/dropinn_standard5.0/';
