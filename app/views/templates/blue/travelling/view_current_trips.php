 ...
 <div class="Box" id="View_Currents_Tips">
   ...
   <?php } ?>
      ...
      <div id="searching"> 
       ...
       <p>
       <input value="Where are you going?" onclick="clear_location(this);" type="text" class="location rounded_left med_4 mal_6" autocomplete="off" id="location" name="location" />
